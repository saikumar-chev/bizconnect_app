...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5-10-5-10 5zM12 14.472L4.5 11 12 7.528 19.5 11 12 14.472z"></path>
    </svg>
);
...
export const DollarIcon: React.FC<IconProps> = ({ className }) => (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 12v.01M12 12v-1m0 1H9.5M12 12H14.5M12 16v1m0-1v-.01M12 16H9.5M12 16H14.5m-5 3H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2h-1"
      />
    </svg>
);
